...
public class AutoBalanceSwerve extends CommandBase {
  ...
  public AutoBalanceSwerve(Joystick joystick, DriveTrainMain driveSubsystem) {
  ...
  @Override
  public void execute() {
    double xAxisRate = joystick.getX();
    double yAxisRate = joystick.getY();
    ...
    double rollAngleDegrees  = ahrs.getRoll();
     ...
     if ( !autoBalanceXMode && 
            ...
            // driveSubsystem.cartesian(xAxisRate, yAxisRate, joystick.getTwist(), 0);
  }
